...
- [x] **1.1 Record quality gate baselines**
  ...
  - Done when:
    - `.ralph/baselines/update-copilotkit-v1-61-typecheck.txt` exists with the full output of `npx tsc --noEmit`
    - the captured gate file ends with a literal `EXIT=0` line
    - `.ralph/baselines/update-copilotkit-v1-61-readme.md` lists passing/failing gates, exit codes, and exact failing identifiers
...
- [x] **2.1 Upgrade CopilotKit packages to 1.61.0**
  - Scope: `package.json`, `package-lock.json`
  - Change: Upgraded copilotkit packages to version 1.61.0.
  - Done when:
    - package.json shows @copilotkit/react-core, @copilotkit/react-ui, @copilotkit/react-textarea, and @copilotkit/runtime at 1.61.0
