...
This capability provides the agent with access to a structured knowledge base containing domain documentation for truss and roof engineering. The knowledge base enables the agent to retrieve relevant engineering documents, specifications, and project information to answer technical questions accurately.

TBD: Add detailed capability description and context.
