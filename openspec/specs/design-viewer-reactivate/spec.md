...
The Design Viewer Reactivate capability provides click-to-reactivate behavior for inactive CAD viewers, allowing users to switch which design entry displays a live `CadViewer` without requiring screenshot capture.
