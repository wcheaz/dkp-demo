...
Defines the requirements for creating an English-translated copy of the roof-truss project directory tree, translating all Slovak, German, and Czech filesystem names while preserving file contents verbatim.
