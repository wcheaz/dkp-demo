...
Defines the structured data collection capability: the DesignParameters model shared between backend and frontend, the frontend tool for updating parameters, the agent's iterative collection loop, and the parameter state visibility to the agent.
