          ...
          <table className="w-full text-sm text-left">
            <tbody>
              <tr className="border-b border-white/10">
                <td className="py-1.5 text-gray-300">Floor Area</td>
                <td className="py-1.5 text-white text-right">
                  {fmt(breakdown.floorArea)} m&sup2;
                </td>
              </tr>
              <tr className="border-b border-white/10">
                <td className="py-1.5 text-gray-300">Joints</td>
                <td className="py-1.5 text-white text-right">
                  {fmt(breakdown.totalJoints)}
                </td>
              </tr>
              <tr className="border-b border-white/10">
                <td className="py-1.5 text-gray-300">Gusset Plate Cost</td>
                <td className="py-1.5 text-white text-right">
              ...
              <tr className="border-b border-white/10">
                <td className="py-1.5 text-gray-300">Timber Volume</td>
                <td className="py-1.5 text-white text-right">
                  {fmt(breakdown.timberVolume)} m&sup3;
                </td>
              </tr>
              <tr className="border-b border-white/10">
                <td className="py-1.5 text-gray-300">Timber Cost</td>
                <td className="py-1.5 text-white text-right">
              ...
              <tr className="border-b border-white/10">
                <td className="py-1.5 text-gray-300">Trusses</td>
                <td className="py-1.5 text-white text-right">
                  {fmt(breakdown.totalTrusses)}
                </td>
              </tr>
              <tr className="border-b border-white/10">
                <td className="py-1.5 text-gray-300">Assembly Cost</td>
                <td className="py-1.5 text-white text-right">
              ...
              <tr className="border-b border-white/10">
                <td className="py-1.5 text-gray-300">Hanger Cost</td>
                <td className="py-1.5 text-white text-right">
              ...
              <tr className="border-b border-white/20 font-semibold">
                <td className="py-1.5 text-gray-200">Subtotal</td>
                <td className="py-1.5 text-white text-right">
                  {fmt(breakdown.subtotalCZK)} CZK
                </td>
              </tr>
              <tr className="border-b border-white/10">
                <td className="py-1.5 text-gray-300">Roof Type</td>
                <td className="py-1.5 text-white text-right">
              ...
              <tr className="border-b border-white/20 font-semibold">
                <td className="py-1.5 text-gray-200">Total (CZK)</td>
                <td className="py-1.5 text-white text-right">
                  {fmt(breakdown.totalCZK)} CZK
                </td>
              </tr>
              <tr className="font-bold">
                <td className="py-1.5 text-gray-100">Total (EUR)</td>
                <td className="py-1.5 text-white text-right">
