...
function parseAxis2Placement3D(entities, placementId) {
...
function resolvePlacement3D(entities, placementId, visited = new Set()) {
    ...
    const parentRef = entity.args[0] && entity.args[0] !== "$"
